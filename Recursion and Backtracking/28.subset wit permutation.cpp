...
public:
    ...
    void helper(string &nums, unordered_map<char, int> &freq, int box)
    {
        ...
        {
            if (p.second > 0)
            //Put in box  and set for backtrack
            {
                nums[box] = p.first;
                p.second--;
                res++;
...
public
    static boolean canPlaceHori(int r, int c, char[][] crossword, String word)
    {
...
public
    static boolean canPlaceVert(int r, int c, char[][] crossword, String word)
    {
...
public
    static String placeHori(int r, int c, char[][] crossword, String word)
    {
        String oldWord = "";
        for (int i = 0; i < word.length(); i++)
        {
...
public
    static String placeVert(int r, int c, char[][] crossword, String word)
    {
        String oldWord = "";
        for (int i = 0; i < word.length(); i++)
        {
...
public
    static void solution(char[][] crossword, String[] words, int vidx)
    {
